...
export default function FilterChipBar({
  ...
  return (
    <div
      ref={containerRef}
      className="relative mb-3 flex select-none items-center justify-between gap-3"
    >
        ...
        {facets.map((facet) => {
          ...
          return (
            <div key={facet.key} className="relative shrink-0">
              ...
              {isOpen && (
                <div className="animate-dropdown-in absolute right-0 top-[calc(100%+0.375rem)] z-20 max-h-64 min-w-[10rem] overflow-y-auto scrollbar-thin rounded-lg border border-border bg-surface py-1 shadow-lg divide-y divide-border/60">
